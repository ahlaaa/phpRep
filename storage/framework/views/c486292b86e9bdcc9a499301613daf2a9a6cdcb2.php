<div class="col-sm-12" style="padding: 35px 0px!important;">
    ...
    <div class="form-group col-sm-12">
        ...
        <div class="col-sm-6">
            <?php echo Form::text('name',null,['class'=>'form-control','style'=>'width:35%;','placeholder'=>'树苗名称']); ?>
    ...
    <div class="form-group col-sm-12">
        ...
        <div class="col-sm-6">
            <?php echo Form::number('price',$product->price??1,['class'=>'form-control','style'=>'width:35%;','placeholder'=>'树苗价格','step'=>0.01]); ?>
    ...
    <div class="form-group col-sm-12">
        ...
        <div class="col-sm-6">
            <?php echo Form::select('status',constants('CATE_STATUS'),null,['class'=>'form-control','style'=>'width:35%;']); ?>
...
<div class="form-group col-sm-12">
    ...
    <a href="<?php echo route('products.index',['type'=>6]); ?>" class="btn btn-default">返回</a>
</div>
