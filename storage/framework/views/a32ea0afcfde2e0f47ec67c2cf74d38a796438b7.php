...
<div class="form-group col-sm-6">
    ...
    <?php echo Form::select('type',constants('CERT_TYPE'), $cert->type ?? null, ['class' => 'form-control','id'=>'card_type']); ?>

</div>
<!-- Img Field -->
<div class="form-group col-sm-12">
    <?php echo Form::label('images', '证书图片:'); ?>

    <div class="controls">
        <input id="images_file" type="file" class="file-loading" accept="image/*">
        <input type="hidden" name="images" id="images" value="<?php echo e($cert->images ?? ''); ?>">
    </div>
</div>
...
<div class="form-group col-sm-12 col-lg-12" id="con_hide">
    ...
    <div id="content_div" style="width:100%; height:200px;"><?php echo $cert->remark ?? ''; ?></div>
    <?php echo Form::textarea('remark', $cert->remark ?? '', ['class' => 'form-control', 'id'=> 'content']); ?>
...
<div class="form-group col-sm-12">
    ...
    <a href="<?php echo route('syscerts.index'); ?>" class="btn btn-default">返回</a>
</div>
