<table class="table table-responsive" id="grades-table">
    <thead>
        <tr>
            ...
            <td colspan="5">
                <button type="button" onclick="javascript:status_change(this);" class="col-sm-3 btn btn-default" data-id="1">上架</button>
...
<script>
    ...
    function status_change(e){
        if ($("#grades-table thead input[type='checkbox']").eq(0).prop('checked')){
            ...
            if(1===$(e).data('id')) {
                $("#status_change").append('<input type="text" value="1" name="change_type"/>');
