...
<!--            <div class="form-group col-sm-12 col-lg-12">-->
                <div id="content_div" style="width:100%; height:200px;"><?php echo optional($product??null)->content??''; ?></div>
                <?php echo Form::textarea('content', old('content'), ['class' => 'form-control', 'id'=> 'content','style'=>'resize:none;']); ?>
