<table class="table table-responsive" id="articles-table">
    ...
    <tr>
        ...
        <td><?php echo $card->type_str; ?></td>
        <td>
            <?php echo Form::open(['route' => ['cards.destroy', $card->id], 'method' => 'delete']); ?>

            <div class='btn-group'>
                <a href="<?php echo route('cards.edit', [$card->id]); ?>" class='btn btn-default btn-xs'><i
