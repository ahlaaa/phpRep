...
<div class="form-group col-sm-6">
    <?php echo Form::label('name', '勋章名称:'); ?>

    <?php echo Form::text('name', null, ['class' => 'form-control']); ?>

</div>
<div class="form-group col-sm-6">
    <?php echo Form::label('prob_num', '勋章概率(%):'); ?>

    <?php echo Form::number('prob_num', null, ['class' => 'form-control','step'=>'0.01','id'=>'prob_num']); ?>

</div>
<!-- Img Field -->
<div class="form-group col-sm-12">
    <?php echo Form::label('images', '勋章图片:'); ?>
...
<div class="form-group col-sm-12 col-lg-12" id="con_hide">
    ...
    <div id="content_div" style="width:100%; height:200px;"><?php echo $medal->remark ?? ''; ?></div>
    <?php echo Form::textarea('remark', $medal->remark ?? '', ['class' => 'form-control', 'id'=> 'content']); ?>
...
<div class="form-group col-sm-12">
    ...
    <a href="<?php echo route('medals.index'); ?>" class="btn btn-default">返回</a>
</div>
