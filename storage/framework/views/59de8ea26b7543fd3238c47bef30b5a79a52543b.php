    ...
    <div class="col-sm-12 ls_div pull-left" style="margin-top: 9px;display: flex;">
        ...
        <div class="col-sm-7" style="margin-left: 25px;background-color: #ccc;padding: 10px 10px;min-height: 75%;">
            ...
            <label class="col-sm-12">
                ...
                <input type="number" name="grades[<?php echo $grade->id; ?>][percentage]" value="<?php echo ($grades_list[$grade->id]->pivot??null)->percentage??''; ?>" class="form-group form-control col-sm-10" step="0.01" style="width: 27%;margin: 8px auto;padding-right: 25px;"/>
                <span class="form-group form-control col-sm-3" style="border: 1px solid white;margin: 8px auto;width: 19%;">折 或者 会员价</span>
                <input type="number" name="grades[<?php echo $grade->id; ?>][price]" value="<?php echo ($grades_list[$grade->id]->pivot??null)->price??''; ?>" class="form-group form-control col-sm-10" style="width: 27%;margin: 8px auto;" step="0.01">
