<table class="table table-responsive" id="articles-table">
    ...
    <tr>
        ...
        <td><?php echo $cert->type_str; ?></td>
        <td>
            <?php echo Form::open(['route' => ['syscerts.destroy', $cert->id], 'method' => 'delete']); ?>

            <div class='btn-group'>
                <a href="<?php echo route('syscerts.edit', [$cert->id]); ?>" class='btn btn-default btn-xs'><i
