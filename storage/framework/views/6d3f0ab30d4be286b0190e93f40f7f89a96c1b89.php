...
<head>
    ...
    <title><?php echo constants('APP_NAME'); ?></title>
...
<center><a style="color:white;" href="<?php echo e(url('/home')); ?>"><b><?php echo constants('APP_NAME'); ?></b></a></center>
    <!-- <span>管理员登录</span> -->
</div>
<form method="post" action="<?php echo e(url('/login')); ?>">
            <?php echo csrf_field(); ?>

            <div class="has-feedback <?php echo e($errors->has('username') ? ' has-error' : ''); ?> login_fields" style="width:100%;">
                ...
                <!--name-->
                    <input type="text" class="form-group form-control" style="width:95%;padding-left: 41px;background-color: white;"  name="username" value="<?php echo e(old('username')); ?>" autocomplete="off"  placeholder="用户名">
                ...
                <br>
                 <div class="has-feedback<?php echo e($errors->has('password') ? ' has-error' : ''); ?> login_fields__password" style="padding-left: 19px;">
                    <div class='icon' style="background-color:#000;border-radius: 24%;">
                        <img alt="" src='jl/img/lock_icon_copy.png'>
                    </div>
                    <input type="password" class="form-group form-control"  placeholder="密码" style="width:95%;padding-left: 41px;background-color: white;" name="password" autocomplete="off" value="<?php echo e(old('password')); ?>">
                    <!-- autocomplete="off" 禁止记录 -->
                ...
                <!--<div class="login_fields__password has-feedback<?php echo e($errors->has('password') ? ' has-error' : ''); ?>">
                <div class='icon'>
