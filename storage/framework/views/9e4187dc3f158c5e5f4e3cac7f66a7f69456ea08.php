    ...
    <div class="col-sm-12 ls_div pull-left" style="margin-top: 9px;display: flex;" id="unuse_standards">
        ...
        <div class="col-sm-7" style="margin-left: 25px;background-color: #ccc;padding: 10px 10px;min-height: 100%;">
            <label class="col-sm-6 form-group">
                <?php echo Form::label('code', '编码:',['class' => 'col-sm-4','style'=>'margin: 8px auto;']); ?>

                <?php echo Form::text('code', null, ['class' => 'form-control col-sm-10','style'=>'width: 65%;margin: 8px auto;','placeholder'=>'数字越大，排名越靠前,如果为空，默认排序方式为创建时间']); ?>
            ...
            <label class="col-sm-5 form-group">
                <?php echo Form::label('bar', '条码:',['class' => 'col-sm-3','style'=>'margin: 8px auto;']); ?>

                <?php echo Form::text('bar', null, ['class' => 'form-control col-sm-10','style'=>'width: 70%;margin: 8px auto;','placeholder'=>'数字越大，排名越靠前,如果为空，默认排序方式为创建时间']); ?>
            ...
            <label class="col-sm-12 form-group">
                <?php echo Form::label('weig', '重量:',['class' => 'col-sm-2','style'=>'margin: 8px auto;']); ?>

                <?php echo Form::text('weig', null, ['class' => 'form-control col-sm-7 form-group','style'=>'width: 60%;margin: 8px auto;','placeholder'=>'数字越大，排名越靠前,如果为空，默认排序方式为创建时间']); ?>

                <?php echo Form::label('weig', '克:',['class' => 'form-group form-control col-sm-3','style'=>'border: 1px solid white;margin: 8px auto;width: 6%;']); ?>
            ...
            <label class="col-sm-12 form-group">
                <?php echo Form::label('is_showQty', '库存:',['class' => 'col-sm-2','style'=>'margin: 8px auto;']); ?>

                <?php echo Form::text('qty', null, ['class' => 'form-control col-sm-7 form-group','style'=>'width: 60%;margin: 8px auto;','placeholder'=>'商品的剩余数量，如启用多规格或为虚拟卡密产品，则此处设置无效']); ?>
            ...
            <!--     <span class="col-sm-2" style="margin: 8px auto;">库存:</span>
                ...
                <label class="form-group form-control col-sm-3" style="width: 19%;margin: 8px auto;background-color: inherit;border: none;">
                    ...
                    <?php echo Form::hidden('is_showQty','0',['id'=>'is_showQty1']); ?>

                    
                    <input type="checkbox" id="is_showQty" name="is_showQty" style="width: 17%;" value="1" <?php echo 1===($product->is_showQty??0)?'checked':''; ?> />
                    <?php echo Form::label('is_showQty', '显示库存:',['style'=>'margin: 8px auto;width:70%;']); ?>
            ...
            <label class="col-sm-10 form-group pull-right">
                <label class="col-sm-3 form-group">
                    <input type="radio" name="is_subtract" value='1' <?php echo ($product->is_subtract??1)==1?'checked':''; ?>/><span>拍下减库存</span>
                </label>
                <label class="col-sm-3 form-group">
                    <input type="radio" name="is_subtract" value='2' <?php echo ($product->is_subtract??1)==2?'checked':''; ?> /><span>付款减库存</span>
                </label>
                <label class="col-sm-3 form-group">
                    <input type="radio" name="is_subtract" value='3' <?php echo ($product->is_subtract??1)==3?'checked':''; ?> /><span>永不减库存</span>
                </label>
            </label>
        </div>
    </div>
                ...
                <div class="tab-pane fade" id="is_cate">
                    ...
                    <div class="col-sm-12" id="all_cate">
                        ...
                        <div class="col-sm-12 form-group base_cate">
                            ...
                            <?php else: ?>
                                ...
                                ?>
                                <?php $__currentLoopData = $standards; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index=>$standard): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php $flag = false; ?>
                                <div class="panel panel-default form-group col-sm-12">
                                    <?php if(!$flag): ?>
                                        <div class="panel-heading col-sm-12 father_cate">
                                            <input type="text" class="form-group form-control col-sm-10" value="<?php echo $index; ?>" style="width: 75%;margin: 8px auto;padding-right: 25px;"/>
                                            <span class="form-group form-control col-sm-3 btn btn-primary" style="border: 1px solid white;margin: 8px auto;width: 19%;" onclick="add_child(this);">添加规格项</span>
                                            <span class="form-group form-control col-sm-3 btn btn-danger" style="width: 6%;border: 1px solid white;margin: 8px auto;" onclick="remove_cate(this);">X</span>
                                        </div>
                                        <?php $flag = true; ?>
                                    ...
                                    <div class="panel-body col-sm-12 children_cates">
                                        <?php $__currentLoopData = $standard; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $std): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <span class="col-sm-4 form-group" style="padding: 0px;">
                                                <input value="<?php echo $std; ?>" type="text" class="form-group form-control col-sm-10 children_cate" style="width: 75%;margin: 8px auto;" />
                                                <span class="form-group form-control col-sm-3 btn btn-danger" style="width: 20%;border: 1px solid white;margin: 8px auto;" onclick="javascript:remove_child(this);">X</span>
                                            </span>
                    ...
                    <div class="form-group col-sm-12">
                        <table class="table">
                            <thead id="cate_head">
                            <tr>
                                <?php if(isset($cates_head)): ?>
                                    <?php $__currentLoopData = $cates_head; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $head): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <th class="in_add"><span class="col-sm-12" style="padding: 0px;"><?php echo $head; ?></span></th>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                <?php endif; ?>
<!--                                <th><span class="col-sm-12" style="padding: 0px;">颜色</span></th><th><span class="col-sm-12" style="padding: 0px;">尺寸</span></th>-->
                            ...
                            <tbody id="cate_body">
                            <?php if(sizeof($product->cates??[])>0): ?>
                                <?php $__currentLoopData = $product->cates; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cate): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                <?php $cts = explode(',',$cate->name); ?>
                                <?php $__currentLoopData = $cts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <td><?php echo $value; ?></td>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            <td><input type="number" data-id="<?php echo $cate->qty.',qty'; ?>" class="col-sm-12 form-control qty" value="<?php echo $cate->qty; ?>" /></td>
                            <td><input step="0.01" type="number" data-id="<?php echo $cate->pre_price.',pre_price'; ?>" class="col-sm-12 form-control pre_price" value="<?php echo $cate->pre_price; ?>" /></td>
                            <td><input step="0.01" type="number" data-id="<?php echo $cate->price.',price'; ?>" class="col-sm-12 form-control price" value="<?php echo $cate->price; ?>" /></td>
                            <td><input step="0.01" type="number" data-id="<?php echo $cate->old_price.',old_price'; ?>" class="col-sm-12 form-control old_price" value="<?php echo $cate->old_price; ?>" /></td>
                            <td><input step="0.01" type="number" data-id="<?php echo $cate->base_price.',base_price'; ?>" class="col-sm-12 form-control base_price" value="<?php echo $cate->base_price; ?>" /></td>
                            <td><input type="text" data-id="<?php echo $cate->code.',code'; ?>" class="col-sm-12 form-control code" value="<?php echo $cate->code; ?>" /></td>
                            <td><input type="text" data-id="<?php echo $cate->bar_code.',bar_code'; ?>" class="col-sm-12 form-control bar_code" value="<?php echo $cate->bar_code; ?>" /></td>
                            <td><input step="0.01" type="number" data-id="<?php echo $cate->weight.',weight'; ?>" class="col-sm-12 form-control weight" value="<?php echo $cate->weight; ?>" /></td>
                            </tr>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            <?php endif; ?>
<!--                            <tr>-->
