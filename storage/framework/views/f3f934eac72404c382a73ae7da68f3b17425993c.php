...
<input type="hidden" name="XXX" id="getPID" value="<?php echo optional($tourist)->id??''; ?>" />
...
<div class="col-sm-12">
    <div class="form-group col-sm-3">
        ...
        <?php echo Form::select('status',constants('TOURIST_STATUS'),optional($tourist)->status??null,['class'=>'form-control select']); ?>
...
<div class="form-group col-sm-3">
    <?php echo Form::label('user_id','开团用户'); ?>
...
//            return $item;
    ...
    ?>
    <?php echo Form::select('user_id',$arr,optional($tourist)->user_id??null,['class'=>'form-control select']); ?>

</div>
<div class="form-group col-sm-3">
    <?php echo Form::label('name','开团名称'); ?>
...
<div class="form-group col-sm-3">
    <?php echo Form::label('route_id','路线选择'); ?>

    <?php echo Form::select('route_id',app(\App\Models\Route::class)->pluck("name","id")->toArray(),null,['class'=>'form-control']); ?>

</div>
</div>
<div class="col-sm-12">
    <div class="form-group col-sm-6">
        <?php echo Form::label('begin_at', '开始时间:',['class'=>'col-sm-12','style'=>'padding:0px;']); ?>

        <?php echo Form::text('begin_at', optional($tourist)->begin_at??date('Y-m-d H:i:s'), ['class' => 'form-control col-sm-5 date block','id'=> 'datepicker1' ,'autocomplete'=>"off",'style'=>'width:45%;','data-provide'=>"datepicker"]); ?>
    ...
    <div class="form-group col-sm-6">
        <?php echo Form::label('end_at', '结束时间:',['class'=>'col-sm-12','style'=>'padding:0px;']); ?>

        <?php echo Form::text('end_at', optional($tourist)->end_at??date('Y-m-d H:i:s',strtotime('+1 day')), ['data-provide'=>"datepicker",'class' => 'form-control col-sm-5 date block','id'=> 'datepicker2'  ,'autocomplete'=>"off",'style'=>'width:45%;']); ?>
...
<div class="form-group col-sm-12">
    <?php echo Form::label('remark','说明',['class'=>'col-sm-3']); ?>

    
    <div class="col-sm-8" id="content_div" style="width:100%; height:200px;"><?php echo optional($tourist)->remark??''; ?></div>
    <?php echo Form::textarea('remark', old('remark'), ['class' => 'form-control', 'id'=> 'remark','style'=>'resize:none;']); ?>
...
<div class="col-sm-12">
    <div class="form-group col-sm-6 pull-left">
        ...
        <label>人数(<?php echo sizeof($users); ?>)</label>
    </div>
...
<!--                <th>支付金额</th>-->
            ...
            <tr>
                ...
                <td><?php echo constants('UO_STATUS')[$user->pivot->status]; ?></td>
                <td><a href="<?php echo url('tourists.out/'.($user->pivot->id)); ?>" class="btn btn-xs btn-danger">退出</a></td>
            </tr>
...
<div class="form-group col-sm-12">
    ...
    <a href="<?php echo route('tourists.index'); ?>" class="btn btn-default">返回</a>
</div>
...
<link type="text/css" href="<?php echo e(URL::asset('/choosen/chosen.min.css')); ?>" rel="stylesheet"/>
