...
<!--                       placeholder="用户单次购买此商品数量限制"/>-->
                <?php echo Form::label('one_max','单次最多购买:',['class'=>"col-sm-2",'style'=>"margin: 8px auto;"]); ?>

                <?php echo Form::number('one_max',null,['class'=>"form-group form-control col-sm-10",'style'=>"width: 70%;margin: 8px auto;padding-right: 25px;",
                'placeholder'=>"用户单次购买此商品数量限制"]); ?>
...
<!--                       placeholder="用户单次必须最少购买此商品数量限制"/>-->
                <?php echo Form::label('one_min','单次最低购买:',['class'=>"col-sm-2",'style'=>"margin: 8px auto;"]); ?>

                <?php echo Form::number('one_min',null,['class'=>"form-group form-control col-sm-10",'style'=>"width: 70%;margin: 8px auto;padding-right: 25px;",'placeholder'=>"用户单次必须最少购买此商品数量限制"]); ?>
...
<!--                       placeholder="用户购买过的此商品数量限制"/>-->
                <?php echo Form::label('max','最多购买:',['class'=>"col-sm-2",'style'=>"margin: 8px auto;"]); ?>

                <?php echo Form::number('max',null,['class'=>"form-group form-control col-sm-10",'style'=>"width: 70%;margin: 8px auto;padding-right: 25px;",'placeholder'=>'用户购买过的此商品数量限制']); ?>
            ...
            <label class="col-sm-12 form-group">
                ...
                <div class="col-sm-10" style="margin: 8px auto;padding: 0px;">
                    <?php echo Form::select('grade_browse',app(\App\Models\Grade::class)->get()->pluck('name','id'),null,['class'=>"form-control select",'placeholder'=>'请选择...']); ?>
...
<!--                    </select>-->
            ...
            <label class="col-sm-12 form-group">
                ...
                <div class="col-sm-10" style="margin: 8px auto;padding: 0px;">
                    <?php echo Form::select('grade_buy',app(\App\Models\Grade::class)->get()->pluck('name','id'),null,['class'=>"form-control select",'placeholder'=>'请选择...']); ?>
