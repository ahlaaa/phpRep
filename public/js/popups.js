...
/*toast 等待框*/
function jqload(num, sec) {
    var _this = num;
    var this_sec = sec;
    var htm = '';
    if (num == 2) { htm += '<img src="images/loading-1.gif" class="jq-load" style="display: none;">' }
    else {
        htm += '<img src="images/loading-2.gif" class="jq-load" style="display: none;">';
    };
    $('body').append(htm);
    $('.jq-load').fadeIn();
}
