...
class CardAPIController extends AppBaseController
{
    ...
    public function index(Request $request)
    {
        ...
        $articles = $this->articleRepository->with('product')->paginate(15);

        return $this->sendResponse($articles->toArray(), 'Cards获取成功');
    }
    ...
    public function store(CreateCardAPIRequest $request)
    {
        ...
        return $this->sendResponse($articles->toArray(), 'Card保存成功');
    }
    ...
    public function show($id)
    {
        ...
        $article->load('product');

        if (empty($article)) {
            return $this->sendError('Card未找到');
        }

        return $this->sendResponse($article->toArray(), 'Card获取成功');
    }
    ...
    public function update($id, UpdateCardAPIRequest $request)
    {
        ...
        return $this->sendResponse($article->toArray(), 'Card更新成功');
    }
    ...
    public function destroy($id)
    {
        ...
        return $this->sendResponse($id, 'Card删除成功');
    }
}
