...
class RouteAPIController extends AppBaseController
{
    ...
    public function index(Request $request)
    {
        ...
        $articles = $this->articleRepository->with('parameters')->paginate(15);

        return $this->sendResponse($articles->toArray(), 'Route获取成功');
    }
    ...
    public function store(CreateRouteAPIRequest $request)
    {
        ...
        return $this->sendResponse($articles->toArray(), 'Route保存成功');
    }
    ...
    public function show($id)
    {
        ...
        $article->load('parameters');

        if (empty($article)) {
            return $this->sendError('Route未找到');
        }

        return $this->sendResponse($article->toArray(), 'Route获取成功');
    }
    ...
    public function update($id, UpdateRouteAPIRequest $request)
    {
        ...
        return $this->sendResponse($article->toArray(), 'Route更新成功');
    }
    ...
    public function destroy($id)
    {
        ...
        return $this->sendResponse($id, 'Route删除成功');
    }
}
