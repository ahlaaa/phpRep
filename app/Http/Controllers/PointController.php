...
class PointController extends AppBaseController
{
    ...
    public function index(Request $request)
    {
        ...
        $points = $this->pointRepository->paginate(15);
    ...
    {
        foreach ($request->point as $item) {
            $this->pointRepository->update($item, $item['id']);
        }

        Flash::success('献金修改成功');

        return redirect(route('points.edit', [1]));
    }
