...
<div class="form-group col-sm-6">
    {!! Form::label('type', '类型:') !!}
    {!! Form::select('type',constants('CARD_TYPE'), $card->type ?? null, ['class' => 'form-control','id'=>'card_type'])
    !!}
</div>
<div class="form-group col-sm-6 {!! isset($card->type)?$card->type==3?'hide':'':'' !!}" id="card_price">
    {!! Form::label('price', '优惠面额:') !!}
    {!! Form::number('price', null, ['class' => 'form-control','step'=>'0.01']) !!}
</div>
<div class="form-group col-sm-12 {!! isset($card->type)?$card->type==3?'':'hide':'hide' !!}" id="card_product">
    <!-- User Id Field -->
    <div class="form-group col-sm-6">
        {!! Form::label('product_id', '关联商品:') !!}
        <br>
        <div class='row radio'>
            ...
            <div class="col-sm-6" style='padding: 0px 38px;'>
                {!! Form::radio('product_id',$k??null,true,["id"=>'pd'.$k,'class'=>'radio','style'=>'display:
    ...
    <div class="form-group col-sm-6">
        <div class="form-group col-sm-6">
            {!! Form::label('product_num','商品数量/大小:') !!}
            {!! Form::number('product_num',null,['class'=>'form-control']) !!}
        </div>
        <div class="form-group col-sm-6">
            {!! Form::label('product_unit','商品单位:') !!}
            {!! Form::text('product_unit',null,['class'=>'form-control']) !!}
        </div>
    </div>
</div>
...
<div class="form-group col-sm-12 col-lg-12" id="con_hide">
    ...
    <div id="content_div" style="width:100%; height:200px;">{!! $card->remark ?? '' !!}</div>
    {!! Form::textarea('remark', $card->remark ?? '', ['class' => 'form-control', 'id'=> 'content']) !!}
</div>
