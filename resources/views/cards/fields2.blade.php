...
<div class="form-group col-sm-12 ztmswz" style="display:none;">
    <!-- Content Field -->
...
<div class="form-group col-sm-12">
    <!-- User Id Field -->
    <div class="form-group col-sm-3 ztmsyx">
        ...
        foreach ($arr as $k => $v) {
            ...
            ?>
            @if($flag)
            {!! Form::checkbox('products[]',$k??null,true,["id"=>'pd'.$k]) !!}
            @else
            {!! Form::checkbox('products[]',$k??null,false,["id"=>'pd'.$k]) !!}
            @endif
            {!! Form::label('pd'.$k, $v??old($v)) !!}
            <?php
        }
        ?>
