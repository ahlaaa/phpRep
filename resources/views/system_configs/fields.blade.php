...
{!! Form::select('pro_list',app(\App\Models\Product::class)->get()->pluck("name","id"),null,['class'=>'form-control','id'=>'pro_sel','style'=>'display:none;','placeholder'=>'不绑定商品']) !!}
<?php
    $pros = $systemConfig->pro_id??'';
    $pros = explode(",",$pros);
?>
{!! Form::select('pro4img',$pros,null,['class'=>'form-control','id'=>'pro4img','style'=>'display:none;']) !!}
{!! Form::text("pro_id",$systemConfig->pro_id??null,['class'=>'form-control','id'=>'proid4img','style'=>'display:none;']) !!}
{{--<!-- Introduce Field -->--}}
