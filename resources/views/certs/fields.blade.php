...
<div class="form-group col-sm-6">
    {!! Form::label('name', '证书名称:') !!}
    {!! Form::text('name', null, ['class' => 'form-control']) !!}
</div>

<div class="form-group col-sm-6">
    {!! Form::label('type', '类型:') !!}
    {!! Form::select('type',constants('CERT_TYPE'), $cert->type ?? null, ['class' => 'form-control','id'=>'card_type'])
    !!}
</div>
<!-- Img Field -->
<div class="form-group col-sm-12">
    {!! Form::label('images', '证书图片:') !!}
    <div class="controls">
        <input id="images_file" type="file" class="file-loading" accept="image/*">
        <input type="hidden" name="images" id="images" value="{{ $cert->images ?? '' }}">
    </div>
</div>
...
<div class="form-group col-sm-12 col-lg-12" id="con_hide">
    ...
    <div id="content_div" style="width:100%; height:200px;">{!! $cert->remark ?? '' !!}</div>
    {!! Form::textarea('remark', $cert->remark ?? '', ['class' => 'form-control', 'id'=> 'content']) !!}
</div>
...
<div class="form-group col-sm-12">
    ...
    <a href="{!! route('syscerts.index') !!}" class="btn btn-default">返回</a>
</div>
@section('scripts')
<script>
