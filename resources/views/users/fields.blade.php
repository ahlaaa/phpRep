...
@section('scripts')
<script>
    console.log({!! json_encode($list2) !!});
    console.log({!! json_encode($list1) !!});
    ...
    //     $('#prox_city option[value="{!! $user->city ?? null  !!}"]').attr('selected', true)
    //     $('#city').change();
    //     $('#prox_county option[value="{!! $user->county ?? null !!}"]').attr('selected', true)
    // }
    $(function(){
        ...
        var province = "{!! isset($list2->pivot->prox_name4)?$list2->pivot->prox_name4:'' !!}",
            city = '{!! isset($list2->pivot->prox_name3)?$list2->pivot->prox_name3:'' !!}',
            country1 = "{!! isset($list2->pivot->prox_name2)?$list2->pivot->prox_name2:'' !!}";
