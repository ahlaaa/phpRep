...
@section('content')
    <section class="content-header">
        ...
        <h1 class="pull-right">
           <a class="btn btn-primary pull-right" style="margin-top: -10px;margin-bottom: 5px" href="{!! route('routes.create') !!}">新增</a>
        </h1>
        <div>
            <form class="navbar-form navbar-left" style="width:100%;" role="search">
                <div class="form-group">
                    {!! Form::text('type', '1',['class' => 'form-control','style' => 'display:none;']) !!}
                    {!! Form::text('search',null, ['class' => 'form-control','placeholder' => '请输入路线名称']) !!}
