...
@section('scripts')
<script>
    console.log({!! json_encode($product??null) !!});
    function check_form() {
    ...
    $(function () {
        ...
        try{
            if(1==={!! 1===($product->on_standards??0)?1:0 !!}){
